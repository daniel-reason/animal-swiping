  ...
  return knex('dogs').del()
    .then(function () {
      return Promise.all([
        ...
        knex('dogs').insert({id: 10004, name: 'Sally', age: '6 months', breed: 'labrador-mixed', size: 'medium', picture: 'http://www.dogbreedinfo.com/images18/YellowLabLogan3HalfMonths.JPG'}),
        knex('dogs').insert({id: 10005, name: 'Harry', age: '6 months', breed: 'labrador-mixed', size: 'medium', picture: 'http://psylabradory.blog.onet.pl/files/2013/03/25.jpg'}),
      ]);
    });
};
